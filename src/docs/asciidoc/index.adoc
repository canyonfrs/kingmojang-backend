...
==== 단일 메모 조회 요청 샘플
include::{snippets}/memos/get_by_id/http-request.adoc[]

==== 단일 메모 조회 응답 샘플
include::{snippets}/memos/get_by_id/http-response.adoc[]

==== 단일 메모 조회 CURL 샘플
include::{snippets}/memos/get_by_id/curl-request.adoc[]

==== 단일 메모 조회 요청 파라미터
include::{snippets}/memos/get_by_id/path-parameters.adoc[]

==== 단일 메모 조회 응답 필드
include::{snippets}/memos/get_by_id/response-fields.adoc[]
